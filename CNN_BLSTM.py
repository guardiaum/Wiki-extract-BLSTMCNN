...
class CNN_BLSTM(object):
    ...
    def __init__(self, class_, EPOCHS, DROPOUT, DROPOUT_RECURRENT, LSTM_STATE_SIZE, CONV_SIZE, LEARNING_RATE, OPTIMIZER):
        ...
        # save model
        self.modelName = "{}_{}_{}_{}_{}_{}_{}_{}".format(class_, self.epochs,
                                                       self.dropout,
    ...
    def loadData(self, class_):
        ...
        self.trainSentences, self.testSentences = read_file('./data/'+class_+'.csv')
    ...
    def addCharInfo(self):
        ...
        self.testSentences = add_char_information_in(self.testSentences)
    ...
    def embed(self):
        ...
        self.train_set = padding(create_matrices(self.trainSentences, word2Idx, self.label2Idx, case2Idx, self.char2Idx))
        self.dev_set = padding(create_matrices(self.devSentences, word2Idx, self.label2Idx, case2Idx, self.char2Idx))
        self.test_set = padding(create_matrices(self.testSentences, word2Idx, self.label2Idx, case2Idx, self.char2Idx))
    ...
    def verify_model_exists(self):
        filename = "./models/" + self.modelName + ".h5"
    ...
    def writeToFile(self):
        ...
        fileName = "./output/" + self.modelName + ".txt"
